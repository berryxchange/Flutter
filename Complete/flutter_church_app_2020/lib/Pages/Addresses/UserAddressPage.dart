...
import 'package:flutter_church_app_2020/Widget/AddressWidget.dart';
...
class _UserAddressPageState extends State<UserAddressPage>
  ...
  List<UserAddressModel> addresses = List();
  UserAddressModel thisUserAddress;
  int addressIndex = 0;
  ...
  void handleSubmit() {
    ...
    if (form.validate()) {
      ...
      churchDB.launchUserAddressesPath(thisUser, thisUserAddress, "create");
  ...
  void initState() {
    ...
    churchDB = ChurchDB();
    thisUserAddress = UserAddressModel();
  ...
  _getCurrentUsersAddressesEvent(Event event) {
    //thisUserInfo
    var thisAddress = UserAddressModel.fromSnapshot(event.snapshot);
  ...
  _onAddressChanged(Event event) {
    ...
    setState(() {
      addresses[addresses.indexOf(old)] = UserAddressModel.fromSnapshot(event.snapshot);
    });
          ...
          SlideTransition(
            ...
            child: DeleteAddressWidget(
              ...
              actionOne: () {
                ...
                churchDB.launchUserAddressesPath(thisUser, addresses[addressIndex], "delete");
