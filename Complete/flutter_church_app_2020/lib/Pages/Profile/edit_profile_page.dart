...
import 'package:flutter_church_app_2020/Widget/GetPictureWidget.dart';
...
// for the form
  ...
  getPictureFromGallery() async {
    ...
    Future.delayed(const Duration(milliseconds: 1000), () {
      setState(() {
        ...
        print("Final image: $pictureImage, userImage: ${thisUser.userImageUrl}");
  ...
  removeUser(VoidCallback onSignOut) {
    setState(() {
      print("This user is : ${thisUser.userEmail}");
  ...
  void initState() {
    ...
    print("This user image: ${thisUser.userImageUrl}");
        ...
        children: [
                                        ...
                                        children: <Widget>[
                                          TextFormField(
                                            decoration: InputDecoration(
                                              labelText:
                                              "First Name: ${thisUser.userFirstName}",
                                          ...
                                          TextFormField(
                                            decoration: InputDecoration(
                                              labelText:
                                              "Last Name: ${thisUser.userLastName}",
                                              labelStyle: TextStyle(
                                                  fontSize: 14,
                                                  color: Colors.grey),
                                            ),
          ...
          SlideTransition(
            ...
            child: DeleteUserWidget(
              ...
              actionOne: () {
                endDeleteUserAnimation(context, widget.onSignOut);
                setState(() {
