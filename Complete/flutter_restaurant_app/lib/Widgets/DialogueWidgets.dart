...
class DeliveryAddressUpdatedWidget extends StatefulWidget {
  ...
  @override
  _DeliveryAddressUpdatedWidgetState createState() => _DeliveryAddressUpdatedWidgetState();
}

class _DeliveryAddressUpdatedWidgetState extends State<DeliveryAddressUpdatedWidget> {
...
class DeleteAddressWidget extends StatefulWidget {
  ...
  DeleteAddressWidget({this.actionOne, this.actionTwo, this.title, this.subtitle});
...
class CardPaymentUpdatedWidget extends StatefulWidget {
  ...
  @override
  _CardPaymentUpdatedWidgetState createState() => _CardPaymentUpdatedWidgetState();
}
...
class DeleteItemFromListWidget extends StatefulWidget {
  ...
  DeleteItemFromListWidget({this.actionOne, this.actionTwo, this.title, this.subtitle});


  @override
  _DeleteItemFromListWidgetState createState() => _DeleteItemFromListWidgetState();
}
