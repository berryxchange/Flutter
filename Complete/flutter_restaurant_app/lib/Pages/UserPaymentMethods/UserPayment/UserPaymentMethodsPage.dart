...
import 'package:flutter_restaurant_app/Pages/UserPaymentMethods/TransactionDetailPage.dart';
...
import 'package:flutter_restaurant_app/Widgets/NewCardFormWithFloatingBackgroundWidget.dart';
...
class UserPaymentMethodsPageState extends State<UserPaymentMethodsPage>
  ...
  List<OrderModel> titheTransactions = List();
  List<OrderModel> offeringTransactions = List();
...
// Getting card transactions
  ...
  _getUsersTithesEvent(Event event) {
    //thisUserInfo
    OrderModel thisTithe = OrderModel.fromSnapshot(
        event.snapshot);
  ...
  _onUserTithesChanged(Event event) {
    ...
    setState(() {
      titheTransactions[titheTransactions.indexOf(old)] =
          OrderModel.fromSnapshot(event.snapshot);
    });
  }
  ...
  _getUsersOfferingEvent(Event event) {
    //thisUserInfo
    OrderModel thisOffering = OrderModel.fromSnapshot(
        event.snapshot);
