...
class AddressWidget extends StatefulWidget {
  ...
  AddressWidget({this.index, this.deleteAction, this.mainColor, this.subtextColor, this.tabColor, this.deliveryAddresses});
...
class _AddressWidgetState extends State<AddressWidget> {
  ...
  checkApartment(DeliveryAddressModel address){
                  ...
                  Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Text(widget.deliveryAddresses[widget.index].address,
                              style: TextStyle(
                                  fontSize: 16,
                            ...
                            Text(checkApartment(widget.deliveryAddresses[widget.index]),
                              style: TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold,
                                color: widget.mainColor
                        ...
                        Text(
                          ...
                          style: TextStyle(
                              fontSize: 16,
                              color: widget.subtextColor//Colors.grey
                          ),
                        )
                      ],
                    ),
