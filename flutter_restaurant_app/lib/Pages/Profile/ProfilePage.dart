...
import 'package:flutter_restaurant_app/Pages/Profile/edit_profile_page.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  checkImage() {
    ...
    if (thisUser.imageUrl != "" && thisUser.imageUrl != null) {
  ...
  Future checkAndSetChangedUserData({Event event}) async{
    ...
    print(thisCurrentUser.lastName);
    ...
    print("This user is: ${thisUser.lastName}");
    return thisUser;
  }
    ...
    userRef.onChildChanged.listen(null).onData((event) {
      ...
      if(event.snapshot.key == "thisUserInfo"){
        checkAndSetChangedUserData(event: event).then((value) {
          UserModel thisNewUser = value;
          print("Final New User data: ${thisNewUser.lastName}");
          setState(() {
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      CupertinoSwitch(
                                        value: false, //thisUser.mainNotification,//set userNotifications thisInternalUser.mainNotification,
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      CupertinoSwitch(
                                        value: false, //thisUser.socialNotification,
                                        onChanged: (bool newValue) {
                                          //setState(() {
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      CupertinoSwitch(
                                        value: false, //thisUser.prayerNotification,
                                      )
                                    ],
                                  ),
                                ],
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void initState() {
    ...
    userRef = FirebaseDatabase.instance
        .reference()
        .child('users')
        .child(thisUser.uid);//.child("thisUserInfo");
