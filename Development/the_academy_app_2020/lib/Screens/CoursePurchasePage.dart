...
class CoursePurchasePage extends StatefulWidget {
  ...
  CoursePurchasePage({this.course, this.thisCurrentUser});

  @override
  _CoursePurchasePageState createState() => _CoursePurchasePageState();
}
              ...
              child: Hero(
                ...
                child: Center(
                  child: NoPaymentsTabWidget(
                      //coursePayment: widget.course.courseCostPackages[index],
